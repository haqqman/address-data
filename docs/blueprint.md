...
- **User-Submitted Format**: Users can save their address _exactly as it appears physically_ — to handle local naming variations not always captured by Google Maps.
- **AI-Assisted Review**:
