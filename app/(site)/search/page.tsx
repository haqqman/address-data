    ...
    <main className='flex-grow max-w-4xl mx-auto px-4 py-8'>
      ...
      {isLoading && (
        <div className='flex justify-center p-8'>
          <Spinner label='Searching...' color='warning' />
        </div>
      )}
          ...
          <Card className='text-center p-8'>
            <CardBody>
              ...
              <p className='text-sm text-foreground-400 mt-2'>
                Try searching for a different address or estate code.
              </p>
            </CardBody>
          </Card>
        )}
              ...
              <CardHeader>
                <div className='flex items-center gap-3'>
                  ...
                  <h2 className='text-xl font-semibold text-primary'>
                    Estates ({results.estates.length})
                  </h2>
                </div>
              </CardHeader>
                ...
                {results.estates.map((estate) => (
                  ...
                  >
                    ...
                    <div className='flex items-center gap-4 mt-2 text-xs text-foreground-500'>
                      ...
                      <span>
                        Last Updated: {format(estate.updatedAt, 'PP')}
                      </span>
                    </div>
                  </div>
                ))}
      ...
      <Suspense
        fallback={
          <div className='flex-grow flex justify-center items-center'>
            <Spinner label='Loading search...' color='warning' />
          </div>
        }
      >
        <SearchResults />
