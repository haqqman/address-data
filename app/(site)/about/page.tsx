          ...
          <NextUICard className='shadow-xl rounded-xl p-2 bg-background'>
            ...
            <NextUICardBody className='space-y-6 text-lg pt-0'>
              ...
              <p className='text-foreground/90'>
                <strong className='text-primary'>AddressData</strong> is an
                address intelligence platform purpose-built for Nigeria. It
                provides developers, businesses, and admins with tools to
                validate, store, and retrieve Nigerian address data in a
                structured, efficient, and scalable way.
              </p>
              <p className='text-foreground/90'>
                Our system supports manual overrides, geolocation comparisons,
                and machine-readable outputs — all designed to boost accuracy
                and usability in real-world applications.
              </p>
              <h2 className='text-2xl font-semibold pt-4 text-primary'>
                Our Mission
              </h2>
              <p className='text-foreground/90'>
                To provide the most reliable and comprehensive address data
                service for Nigeria, empowering businesses and developers with
                the tools they need for accurate location-based services,
              ...
              <ul className='list-disc list-inside space-y-2 text-foreground/90'>
                <li>
                  Ensure high accuracy of address data through AI and manual
                  verification.
                </li>
                <li>Provide developer-friendly APIs for easy integration.</li>
                <li>
                  Offer structured address storage for maximum compatibility.
                </li>
                <li>
                  Continuously improve our platform based on user feedback and
