...
type ConsoleRole = 'cto' | 'administrator' | 'manager'
...
export default function TeamManagementPage() {
  ...
  const handleOpenEditModal = (userToEdit: User) => {
    ...
    setEditForm({
      ...
      role: userToEdit.role as ConsoleRole,
    })
    setSubmissionStatus(null)
    onEditModalOpen()
  }
      ...
      <div className='space-y-8'>
        <div className='flex justify-between items-center'>
          <div className='flex flex-col space-y-1'>
            ...
            <p className='text-foreground-500'>
              Create, edit, and manage console user accounts. (Visible only to
              CTO)
            </p>
          </div>
          <Button
        ...
        <Card className='shadow-xl rounded-xl bg-background'>
          ...
          <CardBody className='p-2 md:p-4'>
            {isLoadingUsers && (
              <Spinner label='Loading users...' color='warning' />
            )}
            ...
            {!isLoadingUsers && !error && (
              <Table aria-label='Console Users Table' removeWrapper>
                ...
                <TableBody
                  items={consoleUsers}
                  emptyContent='No console users found.'
                >
                  {(item) => (
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                {submissionStatus && (
                  <Card
                    className={`mb-4 ${submissionStatus.type === 'success' ? 'bg-success-50' : 'bg-danger-50'}`}
                  >
                ...
                <p className='text-sm text-foreground-500'>
                  Create a new user account in Firebase Authentication and a
                ...
                <div className='space-y-4 pt-2'>
                  <Input
                    ...
                    value={addForm.email}
                    onValueChange={(v) =>
                      setAddForm({ ...addForm, email: v.toLowerCase().trim() })
                    }
                    variant='bordered'
                  />
                  <Input
                  ...
                  <div className='flex gap-4'>
                    <Input
                      ...
                      onValueChange={(v) =>
                        setAddForm({ ...addForm, firstName: v })
                      }
                      variant='bordered'
                    />
                    <Input
                  ...
                  <Input
                    ...
                    onValueChange={(v) =>
                      setAddForm({ ...addForm, phoneNumber: v })
                    }
                    variant='bordered'
                  />
                  <Select
                    ...
                    onSelectionChange={(keys) =>
                      setAddForm({
                        ...addForm,
                        role: Array.from(keys)[0] as ConsoleRole,
                      })
                    }
                    variant='bordered'
                    color='secondary'
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                ...
                <p className='text-sm text-foreground-500'>
                  You are editing the profile for{' '}
            ...
            <>
              ...
              <ModalBody>
                ...
                <p className='text-sm text-danger'>
                  This will remove their profile from the console database but
                  will <span className='font-bold'>NOT</span> delete their
