...
export default function TeamManagementPage() {
  ...
  const [addForm, setAddForm] = useState({ email: "", password: "", firstName: "", lastName: "", phoneNumber: "", role: "manager" as ConsoleRole });
  const [editForm, setEditForm] = useState({ firstName: "", lastName: "", phoneNumber: "", role: "manager" as ConsoleRole });
              ...
              <ModalBody>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <NextUISelect
                    ...
                    onSelectionChange={(keys) => setAddForm({ ...addForm, role: Array.from(keys)[0] as ConsoleRole })}
                    variant="bordered"
                    color="secondary"
                  >
              ...
              <ModalBody>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <NextUISelect
                    ...
                    onSelectionChange={(keys) => setEditForm({ ...editForm, role: Array.from(keys)[0] as ConsoleRole })}
                    variant="bordered"
                    color="secondary"
