    ...
    <div className='space-y-8'>
      <div className='flex justify-between items-center'>
        ...
        <Button
          ...
          isDisabled={
            !adminUser || !['cto', 'administrator'].includes(adminUser.role)
          }
        >
          Create New API Key
        </Button>
        ...
        <CardHeader className='px-6 pt-6 pb-2'>
          <div className='flex flex-col space-y-0.5'>
            ...
            <p className='text-sm text-foreground-500'>
              A list of all API keys issued to developers. Manage their status
              and usage.
            </p>
          </div>
        </CardHeader>
        ...
        <ModalContent>
          {(modalOnClose) => (
            <>
              ...
              <ModalBody>
                <p>
                  Assign a new API key to a portal user. The private key will be
                ...
                >
                  {(userItem) => (
                    <AutocompleteItem
                      key={userItem.id}
                      textValue={
                        userItem.displayName || userItem.email || userItem.id
                      }
                    >
